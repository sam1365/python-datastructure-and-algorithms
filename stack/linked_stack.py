...
class LinkedStack:
    ...
    def push(self, value):
        """Adds a node as head to the top of the stack."""

        self._head = Node(value, self._head)
        self._size += 1

    def peek(self):
        """Returns the node data from the head of the stack."""
    ...
    def pop(self):
        """Removes head and returns its data from the top of the stack."""
